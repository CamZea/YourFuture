...
export default function NavBar(props) {
  ...
  const NavBar = () => {
    ...
    <div className="flex items-center gap-10 text text-gray-600 text-l">
         <Link href="#" className=" hover:text-yellow-600"  to={"/careers"}>Carreras</Link>
         <Link href="#" className=" hover:text-yellow-600"  to={"/programs"}>Programas y becas</Link>
         <Link href="#" className=" hover:text-yellow-600"  to={"/community"}>Comunidad</Link>
         <Link href="#" className=" hover:text-yellow-600"  to={"/about-us"} >Sobre nosotros</Link>
