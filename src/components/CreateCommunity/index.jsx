...
import { addComunidades,fetchComunidades } from "../../services/communityservice";
export default function CreateCommunity() {
  ...
  useEffect(() => {
    ...
    fetchComunidades()
      .then(newData => {
        setCommunity(newData); // Actualizamos el estado con las comunidades obtenidas
      })
      .catch(error => {
    ...
    return
       ...
       addComunidades(communityInput)
          .then(docRef => {
            ...
            const id=docRef.id
            const newCommunityData ={"id":id, "Nombre":communityInput} ;
            setCommunity([...community, newCommunityData]); // Añadimos la nueva comunidad al estado
            // Restablecer el input después de la adición
            setCommunityInput("")
        ...
        <div class="flex items-center ">
            <ul class="">
              ...
              <div className="flex ">
                <div>
                <a
              class=" bg-yellow p-3 text-md font-ligth text-white cursor-pointer "  
