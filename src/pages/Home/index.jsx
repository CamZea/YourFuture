    ...
    <>
      <main>
        <div className="w-full p-6 ">
          <span className="flex w-full justify-center font-semibold text-[#EECF60] text-[30px]">
          ...
          <div>
            <ul className="p-4 grid grid-cols-3 ">
              <li className="flex flex-col">
                <img
                  className="flex h-[30vh] bg-cover p-4 "
                  src={derecho}
                  alt=""
                />
          ...
          <Link to={"/Carreras"}>
            <button className="flex w-full justify-center">
              <span className="border border-[#EECF60] w-[100px] text-[#EECF60] p-1 font-semibold text-[15px] hover:bg-yellow-300 hover:text-black transition-all ease-in-out duration-300">
                Ver más →
              </span>
            </button>
          </Link>
